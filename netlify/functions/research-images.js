// Tynn HTTP-wrapper rundt lib/imageResearch.js — se den filen for selve
// logikken (AI-bilderesearch + faktisk HTTP/Content-Type-verifisering av
// hver foreslåtte bildelenke, med automatisk og:image-fallback).
//
// Kalles fra "🖼️ Finn bilder"-knappen på en sak. Krever innlogget bruker
// (Bearer-token) og OPENAI_API_KEY. På-forespørsel, samme avveining som
